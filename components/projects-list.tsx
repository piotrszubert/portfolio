...
const projectData = [
  {
    ...
    technologiesUsed: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Daisy UI', 'MDX', 'Contentlayer'],
    description:
  ...
  },
  {
    ...
    name: "Dev portfolio",
    imageUrl: "/projects/yu-2.png",
    technologiesUsed: ['Next.js', 'TypeScript', 'Tailwind CSS', 'shadcn/ui', 'MDX', 'Contentlayer'],
    description:
  ...
  },
  {
    ...
    name: "MindCanvas",
    imageUrl: "/projects/yu-2.png",
    technologiesUsed: ['Vite.js', 'Bootstrap 5', 'SCSS', 'JavaScript', 'VanillaTilt', 'AOS'],
    description:
  ...
  },
  {
    ...
    imageUrl: "/projects/yu-2.png",
    technologiesUsed: ['Next.js', 'TypeScript', 'Tailwind CSS', 'React Hook Form', 'zod'],
    description:
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {projectData.map((project) => (
        ...
        >
          <Link className="absolute inset-0" target="_blank" href={project.githubLink}></Link>
          {/* <Image
